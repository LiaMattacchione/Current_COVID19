      ...
      $(this).unbind("click");
        ...
        $.ajax(urlCovid).done(function (response) {
            ...
            for (let i = 0; i < response.records.length; i++) {
                $("#article").append(`<div>
                <a href="${response.records[i].url[0].value}" target="_blank">
                <h4>${response.records[i].title}</h4></a>
        ...
        $.ajax(news).done(function (response) {
            ...
            for (let i = 0; i <= 30; i++) {
                $("#news").append(`<div>
                <a href="${response.news[i].webUrl}" target="_blank">
                <h4>${response.news[i].title}</h4></a>
